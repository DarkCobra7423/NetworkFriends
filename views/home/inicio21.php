    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        <div class="">
          ...
          <form action="controllers/controller-materia.php" method="post" name="f1">
              <div class="form-group">
                  ...
                  <hr>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="First Name" name="firstname" value="<?=$miembro->data->firstname?>">
                    </div>
                  
                  
          <div class="form-group">
            <label class="control-label" for="">Last Name</label>
            <input type="text" class="form-control" placeholder="Last Name" name="lastname" value="<?=$miembro->data->lastname ?>">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-control" placeholder="Email Address" name="email" value="<?=$miembro->data->email ?>">
          </div 
          ...
          <br>
          <label>
            <input type="radio" name="male" value="azul"> Male     
          </label>
          <label>
            <input type="radio" name="female" value="negro"> Female
        </div>

        <div class="form-group">
          <label class="control-label" for="">Username</label>
          <input type="text" class="form-control" placeholder="Username" name="username" value="<?=$miembro->data->username ?>">
        </div>

        <div class="form-group">
          <label class="control-label" for="">Password</label>
          <input type="password" class="form-control" placeholder="Password" name="clave1">
        </div>

        <div class="form-group">
          <label class="control-label" for="">Repeat Password</label>
          <input type="password" class="form-control" placeholder="Repeat Password" name="clave2">
        </div>
