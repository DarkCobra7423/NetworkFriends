    ...
    <div class="row">
      <div class="col-sm-8">
        <div class="login-main">
            <center><img src="resources/img/networkfriendslogo.png"></center>
        </div>
      </div>
        ...
        <div class="">
            <hr>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="First Name" type="text" name='firtsname' value=''/>
                </div>
                    
                <div class="form-group">
                    <label>Last Name</label>
                    <input class="form-control" placeholder="Last Name" type="text" name='lastname' value=''/>
                </div>
          ...
          <!--AQUI FINALIZAN LOS PAISES-->
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Repeat Password" type="password" name='repeatpassword' value=''/>
                </div>
          
          <div class="">
          <label>Birthdate</label>

          <select name="dia" class="form-birthdate" value="">
