                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            while ($row = $departamento->next()) {
                                ...
                                echo "<td>$row->NombreJefe</td>";
                                echo "<td>
                                            <a href='?page=adm-departamento-editar&id=$row->IdDepartamento'>Editar</a>
                                            <a href='$row->IdDepartamento' data-toggle='modal' data-target='#deleteModal' class='linkborrar'>Borrar</a>
                                      </td>";
                                echo "</tr>";
                            }
                            ?>
